...
public class TestaTodos {
	...
	public static void main(String[] args) {
		...
		System.out.println("A idade do cachorro é: "+c1.getIdade()+" anos"+"\nSeu nome é: "+c1.getNome());
		c1.correr();
		c1.emitir();

		System.out.println("\nA idade do cavalo é: "+c2.getIdade()+" anos"+"\nSeu nome é: "+c2.getNome());
		c2.correr();
		c2.emitir();
		
		System.out.println("\nA idade da preguiça é: "+p1.getIdade()+" anos"+"\nSeu nome é: "+p1.getNome());
		p1.subir();
		p1.emitir();
		entrada.close();
	}
